...
def main():
    ...
    for participant in participants:
        openface_preprocossing_object = Openface_Preprocessing(participant, 195, 15)
        participant = openface_preprocossing_object.preparation_for_analysis()